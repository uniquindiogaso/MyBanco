...
public class ModificarClienteUI extends javax.swing.JFrame {
    ...
    public ModificarClienteUI(PrincipalAdmin p, Cliente cliente) {
        this.p = p;
        logica = p.getLogica();
        usuario = cliente;
        initComponents();
    ...
    private void initComponents() {
        ...
        bEliminar.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(bEliminar, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(11, 11, 11)
    ...
    private void eliminarCliente() {
        int cCuentasAhorros = p.getLogica().cuentasAhorrosUsuario(usuario).size();
        int cCuentasCorriente = p.getLogica().cuentasCorrientesUsuario(usuario).size();
        int cCuentasNomina = p.getLogica().cuentasNominaUsuario(usuario).size();
        int cdts = p.getLogica().cdtsUsuario(usuario).size();

        int numCuentas = cCuentasAhorros + cCuentasCorriente + cCuentasNomina + cdts;
