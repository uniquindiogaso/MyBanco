...
public class CrearClienteUI extends javax.swing.JFrame {
    ...
    public CrearClienteUI(Login login) {
        this.login = login;
        initComponents();
        initOtherComponets();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearClienteUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 */
    private void guardar() {
        ...
        if (!noRepetido()) {
            JOptionPane.showMessageDialog(this, "El Cliente ya esta registrado en el Sistema. No se permite duplicar la informacion", "Cliente repetido", JOptionPane.WARNING_MESSAGE);
            return;
        }
 ...
 */
    ...
    private boolean noRepetido() {
        boolean valido = cIdentificacion.getText() != null;
        if (valido) {
            valido = !login.getLogic().validarSiExisteCliente(cIdentificacion.getText());
        }
        return valido;
    }
