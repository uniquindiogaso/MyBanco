 ...
 * @author gusta
 */
public class EmpresaUI extends javax.swing.JFrame {

    private Login login;

    public EmpresaUI(Login login) {
        this.login = login;
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpresaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
